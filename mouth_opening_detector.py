...
while True:
    ...
    for rect in rects:
        ...
        if cnt_outer > 3 and cnt_inner > 2:
            ...
            if 0.2 <= mouth_open_duration <= 0.4:
                print("Please don't talk, otherwise, you will be tagged as a cheater")

        else:
            mouth_open_start_time = None  # Reset the timer if the mouth is closed
            mouth_open_duration = 0

            cv2.putText(img, ' ', (30, 30), font,
                        1, (0, 255, 255), 2)
